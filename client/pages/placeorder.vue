  ...
  <body>
    ...
    <div class="container-fluid ">
      <div class="shipping-address">
        <div class="navbarShipping ">
          <nuxt-link to="/">
            <img src="img/logoSouqna.png" class="img-fluid" />
          </nuxt-link>
        </div>
        <div class="a-row">
                      ...
                      <div class="a-row">
                        <div class="displayAddressDiv">
                          ...
                          <ul class="displayAddressUL">
                            ...
                            <li>{{ $auth.$state.user.address.street }}</li>
                        ...
                        >
                          ...
                          <div class="col-sm-9 col-9">
                            ...
                            <div class="a-row a-color-secondary a-size-small">
                              Sold by:&nbsp;Souqna.com Services, Inc
                            </div>
                            <div class="a-row">
                          ...
                          <div class="a-spacing-mini wednesday">
                            ...
                            <span class="a-radio-label">
                              ...
                              <span class="a-color-secondary"
                                >$15&nbsp;-&nbsp;Standard International Shipping
                                - No Tracking</span
                              >
                            </span>
                          </div>
              ...
              <div class="a-box a-first">
                <div class="a-box-inner">
                  ...
                  <div class="a-row a-spacing-small a-size-small a-text-center">
                    By placing your order, you agree to Souqna's
                    ...
                    <div id="tfx-header">
                      <div class="a-box a-alert-info a-spacing-small">
                        <div class="a-box-inner alert-info-no-icon">
                          <strong>
                            Souqna Currency Converter is Enabled. &nbsp;
        ...
        <div class="a-row a-spacing-small a-spacing-top-small">
          ...
          <p class="a-color-secondary a-size-mini">
            For an item sold by Souqna.com: When you click the "Place your
          ...
          <div class="a-color-secondary a-size-mini">
            <p class="a-color-secondary a-size-mini">
              ...
              apply. See Souqna.com's
              <a href="#">Returns Policy</a>
              <br />
              <br />Go to the <a href="#">Souqna.com homepage</a> without
...
export default {
  ...
  layout: "none",
  computed: {
    ...mapGetters(["getCart", "GetTotalPrice", "GetTotalPriceWithSipping"])
  },
  methods: {
