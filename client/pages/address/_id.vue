            ...
            <div class="a-section">
              ...
              <div class="a-section a-spacing-none a-spacing-top-small">
                <b>
                  ...
                  self-service locations. To add an Souqna Pickup Point or
                  Locker, click
                  <a href="#">here</a>.
                </b>
              </div>
                ...
                <div class="a-spacing-medium a-spacing-top-medium">
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <textarea
                      ...
                      v-model="deleverInstruction"
                      :placeholder="address.deleverInstruction"
                    ></textarea>
                  </div>
                  <!-- Security code -->
                  <div class="a-spacing-top-medium">
                  ...
                  <div class="a-spacing-top-large">
                    <span class="a-button-register">
                      <span class="a-button-inner">
                        <span
                          class="a-button-text"
                          @click="onUpdateAddress(address._id)"
                          >Add address</span
                        >
                      </span>
                    </span>
...
export default {
  async asyncData({ $axios, params }) {
    try {
      ...
      let oneAddress = $axios.$get(`/api/addresses/${params.id}`);
    ...
    async onUpdateAddress(id) {
      try {
        let data = {
          ...
          street: this.street + " " + this.street2,
          securityCode: this.securityCode,
          deleverInstruction: this.deleverInstruction
        };
