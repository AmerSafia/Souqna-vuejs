<template>
  ...
  <main>
    <!--Payment -->
    <div class="registerAddress mt-3 middle_page">
          ...
          <div class="col-sm-6">
            ...
            <div class="a-section">
              ...
              <div class="a-section a-spacing-none a-spacing-top-small">
                <b>The total price is ${{ GetTotalPriceWithSipping }}</b>
              </div>

              <!-- Error message  -->
              <div class="a-section a-spacing-none a-spacing-top-small">
                <div v-if="error">may happend error</div>
                <b></b>
              </div>
...
export default {
  ...
  mounted() {
    this.stripe = Stripe(
      "pk_test_51IRfcQDbrst2vrWuTKLjpsB4rLAIsF8Vvh7Vn7kydkOgh2eMszX1bPwTc1srirEJHtQX7pWA1wx6NSAesuq5QJE200Yn3oI71E"
    );
    ...
    async onPurchase() {
      try {
        ...
        let response = await this.$axios.$post("/api/payment", {
          token: token,
          totalPrice: this.GetTotalPriceWithSipping,
          cart: this.getCart,
