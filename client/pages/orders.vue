<template>
  ...
  <main>
    <!--YOUR ORDER-->
    <div class="container-fluid your-order middle_page">
      <div class="row">
              ...
              <div v-for="product in order.products" :key="product._id">
                ...
                <div class="row">
                  ...
                  <div class="col-xl-10 col-lg-10 col-10">
                    ...
                    <div class="a-row">
                      <span class="a-size-mini a-color-secondary"
                        >Sold by: Souqna Export Sales LLC</span
                      >
                    </div>
                    <div class="a-row">
                      <!-- Product quantity -->
...
export default {
  ...
  computed: {
    ...mapGetters(["GetTotalPriceWithSipping"])
  },
  methods: {
    ...
    async getOrders() {
      try {
        ...
        this.sumtotalPrice(response.products[0]);
