  ...
  <main>
    ...
    <div class="container-fluid">
      <div class="dp-container">
          ...
          <div class="col-lg-3 col-md-3 col-sm-4">
            <div class="leftCol">
              ...
              <div class="authorFollow">
                ...
                <h1 class="authorFollowHeading">Follow The Owner</h1>
          ...
          <div class="col-lg-6 col-md-6 col-sm-8">
            <div class="centerCol">
              ...
              <div class="reviewGroup">
                <i
                  class="fas fa-star"
                  v-for="i in product.averageRating"
                  :key="i"
                ></i>
              </div>
                        ...
                        <span class="a-button-toggle">
                          <span class="a-button-inner">
                            <a href="#" class="a-button-text">
                              ...
                              <br />
                              <span
                                class="a-color-secondary stockQuantityProductPage "
                              >
              ...
              <div class="buyBox">
                ...
                <div class="a-section a-spacing-small">
                  ...
                  <div class="a-section a-spacing-mini">
                    Ships from and sold by souqna.com
                  </div>
                </div>
        ...
        <!-- pass product and reviews to reveiwsection -->
...
export default {
  ...
  async asyncData({ $axios, params }) {
    try {
      ...
      let manyReview = await $axios.$get(`/api/reviews/${params.id}`);
